<template>
  <section>
            ...
            <card shadow class="shadow-lg--hover">
              <div class="d-flex px-3">
                ...
                <div class="pl-4 textSmall">
                  <h5 class="title text-warning">Speed of Delivery</h5>
    ...
    <section class="section section-lg">
      <div class="row row-grid justify-content-center mb-5">
        <div class=".col-lg-8 text-center">
          <h4 class="display-3 colorSchemeHeading text-right">Portfolio</h4>
        </div>
      </div>
      <div class="myContainer mb-5">
        <div class="row justify-content-center">
  ...
  methods: {
    ...
    hideJobDetails() {
      this.$el
        ...
        .parentNode.removeChild(this.$el.querySelector("#carddetails2"));
    },
    showSampleModal() {
      this.showModal = true;
    },
