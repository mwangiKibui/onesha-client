  ...
  <header class="header-global">
    <base-nav class="navbar-main" transparent type effect="dark" expand>
      ...
      <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        ...
        <li class="nav-item">
          <a href="/learn-more" class="nav-link" replace>
            <i class="ni ni-archive-2"></i>
            <span class="nav-link-inner--text">LEARN MORE</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="https://blog.onesha.co.ke" target="_blank" class="nav-link" replace>
            <i class="ni ni-archive-2"></i>
...
(function() {
  ...
  s1.async = true;
  s1.src = "https://embed.tawk.to/5bbb026bb033e9743d02b4e4/default";
  s1.charset = "UTF-8";
