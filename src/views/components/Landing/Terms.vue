    ...
    <main>
        ...
        >
            <div class="container ">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <h4 class="text-default text-center">TERMS OF USE</h4>
                        ...
                        <p>
                            ...
                            1. You must be at least 13 years old to use the Service. <br>
                            ...
                            numbers, non-public phone numbers or non-public email addresses. <br>
                        ...
                        <p>
                            <b>Who Can Use Our Services?</b><br>

                            <b>Service Eligibility: </b> You can only use our Services if you are over 13 years
                            old, it is legal for you to use our Services, and you are legally capable of
                            entering into a binding contract. <br>
                        ...
                        <p>
                            ...
                            <br><br>
                            <b>Subscription Fees.</b><br> Certain Services require you to purchase a
                        ...
                        <p>
                            ...
                            <br><br>
                            (a) A description of the copyrighted work(s) you believe are infringed; <br>
                            ...
                            physical address and telephone number; <br>
                            ...
                            copyright owner’s behalf. <br>
                            (f) Your signature <br><br>
                            ...
                            where there is no infringing use. <br> Please also check to make sure you haven’t
                            ...
                            materials as examples of his or her past work). <br> If you are unsure whether a use
                            ...
                            location where that work resided on the Service; <br>
                            ...
                            notification under DMCA subsection (c)(1)(C) or an agent of such person. <br><br>
                            ...
                            misrepresented that the material was removed by mistake. <br> If you are unsure
                        ...
                        <p>
                            ...
                            Terms") from time to time. Unless we make a change for legal or administrative
                            reasons, we will provide reasonable advance notice before the Updated Terms become
                            effective. You agree that we may notify you of the Updated Terms by posting them on
                            the Service, and that your use of the Service after the effective date of the
                            Updated Terms (or engaging in such other conduct as we may reasonably specify)
                            constitutes your agreement to the Updated Terms. Therefore, you should review these
                            Terms of Use and any Updated Terms before using the Service. The Updated Terms will
                            be effective as of the time of posting, or such later date as may be specified in
                            the Updated Terms, and will apply to your use of the Service from that point
                            forward. These Terms of Use will govern any disputes arising before the effective
